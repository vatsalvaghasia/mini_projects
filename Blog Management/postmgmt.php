...
<!---------------------navbar--------------------->
 ...
 <!---------------------content--------------------->
	<div class = "contents">
    <form method = 'POST'>
		<input type="submit" name='newpost' class="btn blue-btn blue-border" value = "Add Post">
    ...
    if ($endcount > 0) {
          ...
          <td>".$desc_string."</td>
          <td><a name='blog_upd' class='btn yellow-btn' href='editupld.php?post_id=".$row['post_id']."'>Edit</a></td>
          <td>".$row['post_cat']."</td>
          </tr>"; 
          }
        }
  ...
  <?php        
        if(isset($_POST['newpost'])){
          ...
          <form id = 'postadd' action = 'upload.php' method = 'POST' enctype='multipart/form-data'>
         ...
         <input type='submit' class='btn red-btn btn-right'name='fileupload' value='Save'>
      </form>";
      }
    ?>
